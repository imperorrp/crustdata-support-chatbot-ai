...
export const CrustdataLogo = ({ size = 25 }: { size?: number }) => {
  return (
    <svg 
      width={size}
      height={size}
      ...
      style={{ color: "currentcolor" }}
    >
  <path d="M374 116v207H1V1h373v115M136 23a138 138 0 0 0-73 56l-4 8a143 143 0 0 0-14 100 137 137 0 0 0 190 97l11-8a133 133 0 0 0 63-73c11-27 12-55 5-83-9-34-28-61-59-81a130 130 0 0 0-76-22c-14-1-28 1-43 6z" fill="#EDF2F6"/>
  <path d="M309 204c-5 16-13 29-25 42-6-6-7-6-14 1l-19 14-24 14-26 6c-5 2-11 2-16 3l-44-6-8-3c0-5 3-5 5-6l28-11 3-3h1l7-2 17-5 1 7c19-3 36-10 51-22l-7-8 6-3 42-16c6-2 11-5 14-12l4-11v4c0 6-2 12 4 17z" fill="#0E1F73"/>
  <path d="M42 137a129 129 0 0 1 22-58v2l3 6 5-3 10-12-2 7h3l44-17 70-27c3-1 6-2 6-6l7 2 21 6 6 4-3 4-23 10-3 3-13-2-1 6-6 2-18 6V56c-12 0-31 6-43 15-7 5-15 11-20 18-10 10-16 22-21 35h-4l-21 8c-4 2-7 5-8 9l-2 16-2-4-7-16z" fill="#1C308C"/>
  <path d="m237 41-6-4-5-12c11 3 20 9 29 14 31 20 50 47 59 81 7 28 6 56-4 84-7-5-5-11-5-17v-4l3-23-1-15-2-15-4-14-7-18-3-7c-6-9-12-19-21-26a93 93 0 0 0-33-24z" fill="#0D1E71"/>
  <path d="m42 137 7 16 2 4v6l1 5 4 20c1 4 1 8 3 11l16 30 5 8 2 5c3 6 7 11 7 18-24-19-38-44-45-74-4-16-4-32-2-49z" fill="#203490"/>
  <path d="M89 260c0-7-4-12-7-18l-2-4 23 20 30 17 8 3 4 12c-21-5-39-15-56-30z" fill="#1C308C"/>
  <path d="m227 275 24-14 19-14c7-7 8-7 14-1-10 13-23 23-38 30l-13 7-6-8z" fill="#13257B"/>
  <path d="M82 72 72 84l-5 3-3-6v-2c8-14 19-24 32-34 1 5 3 7 8 6L82 72z" fill="#192D86"/>
  <path d="m226 24 5 13-21-6-7-2-18-2-5-10c16-1 31 2 46 7z" fill="#102276"/>
  <path d="m227 275 6 8c-14 7-29 10-45 10l-3-9c5-1 11-1 16-3l26-6zM104 51c-5 1-7-1-8-6 12-10 26-17 41-21l4 8-37 19z" fill="#172A81"/>
  <path d="m185 284 3 9c-14 2-28 1-43-3l-4-12 44 6z" fill="#192D86"/>
  <path d="m141 32-4-8c14-6 28-8 43-7l4 10c-15-1-29 2-43 5z" fill="#12247B"/>
  <path d="M86 124c5-13 11-25 21-35 5-7 13-13 20-18 12-9 31-15 43-15v169a3421 3421 0 0 0-1 30c-14-2-27-7-39-14s-21-16-30-27c-8-13-14-26-17-40l-1-7c-1-15 0-29 4-43z" fill="#06ECC4"/>
  <path d="m308 160-3 23-4 11c-3 7-8 10-14 12l-42 16-6 3-22-22 7-4 71-28c5-2 11-3 11-10l2-1z" fill="#102278"/>
  <path d="m217 203 21 22 8 8c-15 12-32 19-51 22v-7l-1-31v-25l1-10a229 229 0 0 1 22 21z" fill="#FCD613"/>
  <path d="M130 242c12 6 25 11 39 13l-3 3-28 11c-2 1-5 1-5 6l-30-17c-1-4 1-6 5-7l22-9zM194 217v31l-17 5-7 2 1-30 6-2 17-6z" fill="#0F2177"/>
  <path d="M141 32c14-3 28-6 44-5l18 2c0 4-3 5-6 6l-70 27-44 17h-3l2-7 22-21 37-19z" fill="#1C348F"/>
  <path d="m194 62 1-6 13 2c13 3 24 9 34 17l-3 3-44 45-1-15V62z" fill="#FC4B41"/>
  <path d="M86 124c-4 14-5 28-4 43l1 7-19 7c-4 1-7 3-8 7a851 851 0 0 1-5-25v-6l2-16c1-4 4-7 8-9l21-8h4z" fill="#182C86"/>
  <path d="m240 78 2-3c-10-8-21-14-34-17l3-3 23-10 3-4c13 5 23 13 33 24l-30 13zM194 62v18l-9 2-15 5V70l18-6 6-2z" fill="#1B2F8A"/>
  <path d="m239 78 31-13a86 86 0 0 1 24 33l-6 4-31 12-53 20-34 13 1-32 6-2 17-5 1 15 44-45z" fill="#172A84"/>
  <path d="m170 147 34-13 53-20 31-12 6-4 7 18-5 5-15 6-54 21-36 14-21 7v-22z" fill="#152880"/>
  <path d="m217 203-15-15 26-12 79-31 1 15-2 1c0 7-6 8-11 10l-71 28-7 4z" fill="#12247B"/>
  <path d="m170 169 21-7 36-14 54-21 15-6 5-5 4 14-8 6-41 16-66 25-20 7v-15z" fill="#13267E"/>
  <path d="m170 184 20-7 66-25 41-16 8-6 2 15-79 31-26 12-7-6-1 10h-2l-22 8v-16z" fill="#13257D"/>
  <path d="M56 188c1-4 4-6 8-7l19-7c3 14 9 28 17 40l-16 8c-4 2-8 2-9 7l-16-30c-2-3-2-7-3-11z" fill="#142880"/>
  <path d="M75 229c1-5 5-5 9-7l16-7c9 10 18 19 30 26l-22 10c-4 1-6 3-5 7l-23-21-5-8z" fill="#11247A"/>
  <path d="m51 163 1 5-1-5z" fill="#1C308C"/>
  <path d="M194 108a265 265 0 0 1-23 7l-1-28a188 188 0 0 1 24-7v28z" fill="#192D88"/>
  <path d="m170 200 22-8h2v25a314 314 0 0 1-23 8l-1-25z" fill="#12247B"/>
</svg>
  );
};